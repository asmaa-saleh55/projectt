      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-indigo-600">Doctor Helper</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Your trusted platform for managing doctor appointments and patient care efficiently.
          </p>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Medical History</h3>
                  <p className="mt-5 text-base text-gray-500">
